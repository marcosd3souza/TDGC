...
class Clustering_Runner():
    ...
    def erun(self):
        ...
        for epoch in range(self.iteration):
            embedding, _ = update(ae_model, opt, sess, feas['adj_norm'], feas['adj_label'], feas['features'], placeholders, feas['adj'])
        ...
        pred = KMeans(n_clusters=self.n_clusters, random_state=0).fit_predict(embedding)