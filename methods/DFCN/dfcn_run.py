...
from .load_data import LoadDataset, normalize, sparse_mx_to_torch_sparse_tensor
from .train import Train

setup_seed(opt.args.seed)


def run(X, A, n_clusters):
    ...
    pca = PCA(n_components=3)#opt.args.n_input)
    ...
    adj = sparse_mx_to_torch_sparse_tensor(normalize(A))
